        ...
        >
          ...
          {subtext && (
            <motion.p
              ...
              className="mx-auto mb-12 max-w-2xl text-lg text-neutral-700 dark:text-neutral-300"
            >
              {subtext}
            </motion.p>
          )}
